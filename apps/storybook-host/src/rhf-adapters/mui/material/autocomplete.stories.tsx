...
import { MuiAutocompleteElement, MuiButtonElement } from '@piplup/rhf-adapters/mui-material';
import { FormContainer, type FormContainerProps } from '@piplup/rhf-core';
import { action } from '@storybook/addon-actions';
import { type Meta, type StoryObj } from '@storybook/react';

/**
 * A wrapper around the `<Autocomplete>` component pre-configured with `useMuiAutocompleteAdapter`.
 *
 ...
 */
const meta: Meta<typeof MuiAutocompleteElement> = {
  args: {},
  argTypes: {},
  component: MuiAutocompleteElement,
  tags: ['autodocs'],
  title: 'rhf-adapters/mui-material/MuiAutocompleteElement',
};

export default meta;

type Story = StoryObj<typeof MuiAutocompleteElement>;

type FilmOptionType = { title: string; year: number };
...
export const ComboBoxCountrySelect: Story = {
  name: 'Combo Box - Country Select',
  render() {
    const containerProps: Partial<FormContainerProps> = {
      onSubmit(values) {
        action('onSubmit')(values);
...
export const FreeSoloSearchInput: Story = {
