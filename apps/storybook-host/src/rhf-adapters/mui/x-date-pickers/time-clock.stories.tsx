 ...
 */
const meta: Meta<typeof MuiXTimeClockElement> = {
  args: {},
  argTypes: {
    className: {
      control: 'text',
  ...
  component: MuiXTimeClockElement,
  tags: ['autodocs'],
  title: 'RHF-Adapters/mui-x-date-pickers/Time Components/MuiXTimeClockElement',
};

export default meta;

const Template: StoryFn<typeof MuiXTimeClockElement> = (props) => {
  return (
    <LocalizationProvider dateAdapter={AdapterDayjs}>
      <FormContainer onError={action('onError')} onSubmit={action('onSubmit')}>
        <MuiXTimeClockElement {...props} sx={{ mx: 0 }} />
