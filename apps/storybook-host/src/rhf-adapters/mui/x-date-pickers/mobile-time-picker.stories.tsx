...
/**
 * A wrapper around the [\<MobileTimePicker /\>](https://mui.com/x/api/date-pickers/mobile-time-picker/) component pre-configured with `useMuiXDesktopTimePickerAdapter`.
 *
 ...
 */
const meta: Meta<typeof MuiXMobileTimePickerElement> = {
  args: {},
  argTypes: {
    className: {
      control: 'text',
  ...
  component: MuiXMobileTimePickerElement,
  tags: ['autodocs'],
  title: 'RHF-Adapters/mui-x-date-pickers/Time Components/MuiXMobileTimePickerElement',
};

export default meta;

const Template: StoryFn<typeof MuiXMobileTimePickerElement> = (props) => {
  return (
