...
/**
 * A wrapper around the [\<MobileDatePicker /\>](https://mui.com/x/api/date-pickers/mobile-date-picker/) component pre-configured with `useMuiXMobileDatePickerAdapter`.
 *
 ...
 */
const meta: Meta<typeof MuiXMobileDatePickerElement> = {
  args: {},
  argTypes: {
    className: {
      control: 'text',
  ...
  component: MuiXMobileDatePickerElement,
  tags: ['autodocs'],
  title: 'RHF-Adapters/mui-x-date-pickers/Date Components/MuiXMobileDatePickerElement',
};

export default meta;

const Template: StoryFn<typeof MuiXMobileDatePickerElement> = (props) => {
  return (
