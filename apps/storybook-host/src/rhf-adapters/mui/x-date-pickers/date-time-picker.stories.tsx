...
/**
 * A wrapper around the [\<DateTimePicker /\>](https://mui.com/x/api/date-pickers/date-time-picker/) component pre-configured with `useMuiXDateTimePickerAdapter`.
 *
 ...
 */
const meta: Meta<typeof MuiXDateTimePickerElement> = {
  args: {},
  argTypes: {
    className: {
      control: 'text',
  ...
  component: MuiXDateTimePickerElement,
  tags: ['autodocs'],
  title: 'RHF-Adapters/mui-x-date-pickers/Date Time Components/MuiXDateTimePickerElement',
};

export default meta;

const Template: StoryFn<typeof MuiXDateTimePickerElement> = (props) => {
  return (
