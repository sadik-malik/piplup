...
/**
 * A wrapper around the [\<DesktopTimePicker /\>](https://mui.com/x/api/date-pickers/desktop-time-picker/) component pre-configured with `useMuiXDesktopTimePickerAdapter`.
 *
 ...
 */
const meta: Meta<typeof MuiXDesktopTimePickerElement> = {
  args: {},
  argTypes: {
    className: {
      control: 'text',
  ...
  component: MuiXDesktopTimePickerElement,
  tags: ['autodocs'],
  title: 'RHF-Adapters/mui-x-date-pickers/Time Components/MuiXDesktopTimePickerElement',
};

export default meta;

const Template: StoryFn<typeof MuiXDesktopTimePickerElement> = (props) => {
  return (
