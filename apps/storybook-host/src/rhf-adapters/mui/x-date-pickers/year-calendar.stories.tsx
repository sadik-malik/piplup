 ...
 */
const meta: Meta<typeof MuiXYearCalendarElement> = {
  args: {
    className: '',
    disabled: false,
    disableFuture: false,
...
const Template: StoryFn<typeof MuiXYearCalendarElement> = (props) => {
  return (
    <LocalizationProvider dateAdapter={AdapterDayjs}>
      <FormContainer onError={action('onError')} onSubmit={action('onSubmit')}>
        <div>
          <MuiXYearCalendarElement {...props} />
