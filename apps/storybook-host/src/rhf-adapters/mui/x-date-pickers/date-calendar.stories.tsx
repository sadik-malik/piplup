 ...
 */
const meta: Meta<typeof MuiXDateCalendarElement> = {
  args: {
    className: '',
    disabled: false,
    disableFuture: false,
...
const Template: StoryFn<typeof MuiXDateCalendarElement> = (props) => {
  return (
    <LocalizationProvider dateAdapter={AdapterDayjs}>
      <FormContainer onError={action('onError')} onSubmit={action('onSubmit')}>
        <div>
          <MuiXDateCalendarElement {...props} sx={{ mx: 0 }} />
