...
const meta: Meta<typeof MuiSliderElement> = {
  ...
  parameters: {
    docs: {
      description: {
        component: `A wrapper around the \`<Slider>\` component pre-configured with \`useMuiSliderAdapter\`. Props of the Slider component are also available and will be forwarded to the component, if provided.`,
      },
    },
  },
  tags: ['autodocs'],
  title: 'MUI-Material/MuiSliderElement',
};
