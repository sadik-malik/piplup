...
const meta: Meta<typeof MuiRatingElement> = {
  ...
  parameters: {
    docs: {
      description: {
        component: `A wrapper around the \`<Rating>\` component pre-configured with \`useMuiRatingAdapter\`. Props of the Rating component are also available and will be forwarded to the component, if provided.`,
      },
    },
  },
  tags: ['autodocs'],
